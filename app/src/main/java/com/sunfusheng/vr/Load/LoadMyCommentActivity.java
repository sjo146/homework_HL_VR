...
import com.sunfusheng.vr.MyInfo.NoCommentActivity;
...
public class LoadMyCommentActivity extends Activity {
    ...
    Handler handler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            if (msg.arg1 == 1) {
                ...
                Toast.makeText(LoadMyCommentActivity.this, "加载图片完成", Toast.LENGTH_LONG).show();
                getItemZanState();
                isGet = true;
            }
            if (msg.arg2 == 2) {
                Toast.makeText(LoadMyCommentActivity.this, "网络繁忙！稍后再试", Toast.LENGTH_LONG).show();
            }
            if (msg.arg1 == 3&&flag) {
                Intent intent = new Intent(LoadMyCommentActivity.this, MyCommentActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_load_my_comment);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    String resultData = JsonUtil.getJsonString(urlString+"/getMyCommentPic",content);
                    JSONArray data = new JSONArray(resultData);
                    int line = data.length();
                    if(line==0)
                    {
                        System.out.println("收到为0 ");
                        flag=false;
                        Intent intent=new Intent(LoadMyCommentActivity.this, NoCommentActivity.class);
                        startActivity(intent);
