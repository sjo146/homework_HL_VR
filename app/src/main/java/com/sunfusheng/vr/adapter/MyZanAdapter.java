...
public class MyZanAdapter extends RecyclerView.Adapter<MyZanAdapter.ViewHolder> {
    ...
    public MyZanAdapter(Context context) {
        super();
        this.imgMsgs = LoadZanActivity.imgMsgs;
        url = context.getResources().getString(R.string.connecturl);
    }

    public MyZanAdapter(Context context, ArrayList<ImgMsg> imgMsgs) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Boolean iszan =false;
        if (!LoadZanActivity.zans.containsKey(imgMsg.imgid)){
            holder.zan_img.setImageResource(R.mipmap.zan_un);
            LoadZanActivity.zans.put(imgMsg.imgid,false);
        }
        else {
            iszan=LoadZanActivity.zans.get(imgMsg.imgid);
            if (iszan == true)
        ...
        holder.zan_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (LoadZanActivity.zans.get(imgMsg.imgid) == true) {
                    z = false;
                    holder.zan_img.setImageResource(R.mipmap.zan_un);
                } else {
                    z = true;
                ...
                LoadZanActivity.zans.put(imgMsg.imgid, z);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    jsonObject.put("iszan",LoadZanActivity.zans.get(imgid));
